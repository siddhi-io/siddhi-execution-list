...
/**
 * removeAll(LinkedList , LinkedList) implementation.
 */
@Extension(
        name = "removeAll",
        namespace = "list",
        description = "Function returns the updated list after removing all the element with the specified list.",
        parameters = {
                @Parameter(name = "list",
                ...
                @Parameter(name = "given.list",
                        description = "The list with all the elements that needs to removed.",
                        type = {DataType.OBJECT},
                        dynamic = true
                )
        },
