...
public class ContainsFunctionExtensionTestCase {
    ...
    public void testContainsValueFunctionExtension() throws InterruptedException {
        ...
        String query = ("@info(name = 'query1') from inputStream " +
                ...
                "select list:contains(list1, symbol) as doesContains1, " +
                "list:contains(list:create(), price) as doesContains2 " +
    ...
    public void testContainsValueFunctionExtension1() {
        ...
        String query = ("@info(name = 'query1') from inputStream " +
                ...
                "@info(name = 'query3') from outputStream " +
                "select list:isEmpty(list1) as isList1,list:contains(symbol,price) as isList2" +
                " insert into outputStream2;"
        );
