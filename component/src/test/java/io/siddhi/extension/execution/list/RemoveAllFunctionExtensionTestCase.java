...
/**
 * Test case for list:removeAll.
 */
public class RemoveAllFunctionExtensionTestCase {
    private static final Logger log = Logger.getLogger(RemoveAllFunctionExtensionTestCase.class);
    ...
    public void testRemoveFunctionExtension() throws InterruptedException {
        ...
        String query = ("@info(name = 'query1') from inputStream select symbol,price, "
                ...
                + "list:removeAll(list1,list:create(symbol, 'IBM')) as list2"
    ...
    @Test
    public void testRemoveFunctionExtension2() throws InterruptedException {
        log.info("RemoveFunctionExtension TestCase");
        SiddhiManager siddhiManager = new SiddhiManager();
        ...
        String query = ("@info(name = 'query1') from inputStream select symbol,price, "
                + "list:create() as tmpList insert into tmpStream;"
                + "@info(name = 'query2') from tmpStream  select symbol,price,tmpList, " +
                "list:add(list:add(tmpList,symbol), 'ABC') as list1"
                + " insert into outputStream;"
                + "@info(name = 'query3') from outputStream  select list1, "
                + "list:removeAll(list1,list:create(symbol, 'IBM2')) as list2"
                + " insert into outputStream2;"
        );
    ...
    public void testRemoveFunctionExtension3() {
        ...
        String query = ("@info(name = 'query1') from inputStream select symbol,price, "
                ...
                + "@info(name = 'query3') from outputStream  select list1, list:removeAll(list1) as list2"
                + " insert into outputStream2;"
        );
