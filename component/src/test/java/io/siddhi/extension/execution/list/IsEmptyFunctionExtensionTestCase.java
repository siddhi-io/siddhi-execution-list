...
public class IsEmptyFunctionExtensionTestCase {
    ...
    public void testIsEmptyFunctionExtension() throws InterruptedException {
        ...
        String query = ("@info(name = 'query1') from inputStream " +
                ...
                "list:add(tmpList,symbol,0) as list1" +
                " insert into outputStream;" +
                "@info(name = 'query3') from outputStream " +
                "select list:isEmpty(list:create()) as isList1, list:isEmpty(list1) as isList2" +
    ...
    public void testIsEmptyFunctionExtension1() {
        ...
        String query = ("@info(name = 'query1') from inputStream " +
                "select symbol,price,list:create() as tmpList" +
                " insert into tmpStream;" +
                "@info(name = 'query2') from tmpStream  select symbol,price,tmpList, list:add(tmpList,symbol,0) " +
                "as list1 insert into outputStream;" +
                "@info(name = 'query3') from outputStream " +
                "select list:isEmpty(list1) as isList1,list:isEmpty(symbol,price) as isList2" +
                " insert into outputStream2;"
        );
