...
public class ClearFunctionExecutorTestCase {
    ...
    @Test
    public void testClearFunctionExtension() throws InterruptedException {
        log.info("ClearFunctionExtension TestCase");
        ...
        String query = ("@info(name = 'query1') " +
                ...
                "@info(name = 'query3') " +
                "from outputStream " +
                "select list:clear(list1) as clearList1 " +
    ...
    public void testClearFunctionExtension1() {
        ...
        String query = ("@info(name = 'query1') from inputStream " +
                ...
                "select list:clear(symbol,price) as clearList2 " +
                " insert into outputStream2;"
        );
    ...
    @Test(expectedExceptions = SiddhiAppCreationException.class)
    public void testClearFunctionExtension3() {
        log.info("IsListFunctionExtension TestCase with test attributeExpressionExecutors length");
        SiddhiManager siddhiManager = new SiddhiManager();
        ...
        String query = ("@info(name = 'query1') from inputStream " +
                ...
                "as list1 insert into outputStream;" +
                "@info(name = 'query3') from outputStream " +
                "select list:clear(symbol) as clearList " +
                " insert into outputStream2;"
        );
